...
from .base import create_inference_engine, determine_precision, initialize_tabpfn_model
from .constants import ModelInterfaceConfig, XType, YType
from .model.bar_distribution import FullSupportBarDistribution
from .model.preprocessing import ReshapeFeatureDistributionsStep
...
class TabPFNRegressor(RegressorMixin, BaseEstimator):
    ...
    def fit(self, X: XType, y: YType) -> Self:
        ...
        # >>> My addition
        # self.config_.features_per_group = 1
        # self.model_.features_per_group = 1
        # self.config_.nan_handling_enabled = False # pyright: ignore
        ...
        self.executor_ = create_inference_engine(
            ...
            n_jobs=self.n_jobs,
            byte_size=byte_size,
            forced_inference_dtype_=torch.bfloat16,
